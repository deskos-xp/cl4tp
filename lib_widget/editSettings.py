...
class Ui_editSettings(object):
    def setupUi(self, editSettings):
        ...
        self.gridLayout_6.addWidget(self.reset, 0, 2, 1, 1)
        self.clear = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
        self.clear.setObjectName("clear")
        self.gridLayout_6.addWidget(self.clear, 0, 1, 1, 1)
        self.close = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
        self.close.setObjectName("close")
        self.gridLayout_6.addWidget(self.close, 0, 3, 1, 1)
    ...
    def retranslateUi(self, editSettings):
        ...
        self.clear.setToolTip(_translate("editSettings", "set all fields to internal defaults"))
        self.clear.setText(_translate("editSettings", "&Clear"))
