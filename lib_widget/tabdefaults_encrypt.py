...
class Ui_tabdefaults_encrypt(object):
    def setupUi(self, tabdefaults_encrypt):
        ...
        self.infile.setDragEnabled(True)
        self.infile.setClearButtonEnabled(True)
        self.infile.setObjectName("infile")
        self.gridLayout_3.addWidget(self.infile, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.browse_infile, 1, 2, 1, 1)
        self.label = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.label.setObjectName("label")
        self.gridLayout_3.addWidget(self.label, 0, 0, 1, 1)
        self.hashlog = QtWidgets.QLineEdit(self.scrollAreaWidgetContents)
        self.hashlog.setDragEnabled(True)
        self.hashlog.setClearButtonEnabled(True)
        self.hashlog.setObjectName("hashlog")
        self.gridLayout_3.addWidget(self.hashlog, 6, 1, 1, 1)
    ...
    def retranslateUi(self, tabdefaults_encrypt):
        ...
        self.browse_infile.setText(_translate("tabdefaults_encrypt", "Browse"))
